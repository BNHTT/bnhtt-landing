...
export const translations = {
  en: {
    ...
    projects: [
      {
        title: "Orbitacomms C.S.",
        stack: "React · Node.js · Docker",
        subtitle: "Real-time media monitoring dashboard in production for OrbitaComms.",
        desc: "It centralizes news mentions and brand coverage across multiple sources, giving the team instant visibility without manually scanning dozens of outlets.",
        status: "Beta · Production",
        color: "from-[#6EC1E4] to-[#61CE70]",
        logo: "/logos/Orbita/LOGO ORBITACOMMS - Claro.png",
        logoBg: "bg-gradient-to-br from-[#0a1929] to-[#0d2461]",
      },
      {
        title: "Nebula OCR",
        stack: "Python · FastAPI · React",
        subtitle: "Intelligent accounting automation with OCR and AI-powered data extraction.",
        desc: "It extracts structured data from bank statements and invoices automatically — eliminating hours of manual data entry every month.",
        status: "MVP · In development",
        color: "from-[#7C3AED] to-[#A855F7]",
        logo: "/logos/Nebula/logo_nebula_icon.png",
      },
      {
        title: "Seamind Experience",
        stack: "React · TypeScript · Tailwind",
        subtitle: "Premium luxury travel platform focused on curated Bali experiences.",
        desc: "It solves the fragmented booking problem for high-end travelers with a single, beautifully designed interface to discover and plan bespoke trips.",
        status: "Advanced development",
        color: "from-[#0e2a4a] to-[#1a6b6b]",
        logo: "/logos/Seamind/logo_seamind.png",
      },
      {
        title: "Squalo Spain",
        stack: "Shopify · Liquid · AI Imaging",
        subtitle: "Full e-commerce and brand identity project for a Spanish fashion label.",
        desc: "Web redesign, brandbook, and Shopify store for Squalo Club — a Spanish streetwear brand. Included AI-assisted product photography workflow.",
        status: "Delivered",
        color: "from-[#1a3d8c] to-[#0d2461]",
        logo: "/logos/Squalo/squalo_anchor.png",
      },
    ],
    ...
    allProjects: [
      ...
      },
      {
        ...
        stack: "Shopify · Liquid · AI Imaging",
        subtitle: "Full e-commerce and brand identity project for a Spanish fashion label.",
        desc: "Built a complete setup for Squalo Club — a Spanish streetwear brand. Covered web redesign, brandbook, Shopify store setup, and an AI-assisted product photography workflow.",
        status: "Delivered",
        color: "from-[#1a3d8c] to-[#0d2461]",
        logo: "/logos/Squalo/squalo_anchor.png",
      },
  ...
  es: {
    ...
    projects: [
      ...
      },
      {
        ...
        desc: "Lee extractos bancarios y documentos financieros, extrae y estructura los datos automáticamente — eliminando el trabajo manual repetitivo cada mes.",
      ...
      },
      {
        title: "Squalo Spain",
        stack: "Shopify · Liquid · AI Imaging",
        subtitle: "Proyecto completo de e-commerce e identidad de marca para una marca de moda española.",
        desc: "Rediseño web, brandbook y tienda Shopify para Squalo Club — una marca de streetwear española. Incluyó flujo de fotografía de producto con IA.",
        status: "Entregado",
        color: "from-[#1a3d8c] to-[#0d2461]",
        logo: "/logos/Squalo/squalo_anchor.png",
      },
    ...
    allProjects: [
      ...
      },
      {
        ...
        stack: "Shopify · Liquid · AI Imaging",
        subtitle: "Proyecto completo de e-commerce e identidad de marca para una marca de moda española.",
        desc: "Setup completo para Squalo Club — marca de streetwear española. Cubrió rediseño web, brandbook, tienda Shopify y un flujo de fotografía de producto asistida por IA.",
        status: "Entregado",
        color: "from-[#1a3d8c] to-[#0d2461]",
        logo: "/logos/Squalo/squalo_anchor.png",
      },
